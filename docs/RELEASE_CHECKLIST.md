...
| 5 | `cargo test` (lib + integration + gaps_v038 + gaps_v039) | exit 0 |
...
| 16 | Product line docs = Cargo version (DOC-003) | llms/README/AGENTS |
| 17 | (Opcional) `cargo package --allow-dirty --list` dry-run | sem publish automático |
